...
def get_annotation_component():
    ...
    component_dir = os.path.join(tempfile.gettempdir(), "pdf_annotation_component_v4")
    os.makedirs(component_dir, exist_ok=True)
    index_path = os.path.join(component_dir, "index.html")
...
"""
    ...
    return components.declare_component("pdf_annotation_component_v4", path=component_dir)
...
def show_annotation_editor(page_num, page_image, annotations, selected_id, undo_stack, controls):
    ...
    return component(
        ...
        **controls,
        key=f"annotation_editor_v4_page_{page_num}",
        default=None,
    )
    ...
    for item in annotations:
        ...
        if kind in {"rectangle", "circle"}:
            ...
            if kind == "line":
                ...
                shaft_half_width = display_thickness / 2.0
