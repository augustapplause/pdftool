# PDF Toolkit - v0.5
# Annotation fixes: prevent extra Streamlit reruns after canvas commits; rebuild line/arrow during drag so endpoints serialize reliably.
...
def get_annotation_component():
    ...
    component_dir = os.path.join(tempfile.gettempdir(), "pdf_fabric_annotation_component_v5")
...
"""
    ...
    return components.declare_component("pdf_fabric_annotation_component_v5", path=component_dir)
        ...
        if event is not None:
            try:
                ...
                if (
                    ...
                    # Do not force a second Streamlit rerun here. The canvas has already
                    # committed its state to Python; an immediate st.rerun() remounts the
                    # Fabric iframe and can make freshly drawn lines/arrows appear to vanish.
            except Exception as e:
