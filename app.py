# PDF Toolkit - v0.6
# Annotation fixes: rerun after canonical Fabric snapshot is saved; use robust line endpoint serialization.
...
def get_annotation_component():
    ...
    component_dir = os.path.join(tempfile.gettempdir(), "pdf_fabric_annotation_component_v6")
...
"""
    ...
    return components.declare_component("pdf_fabric_annotation_component_v6", path=component_dir)
