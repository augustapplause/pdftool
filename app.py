...
def get_annotation_component():
    ...
    component_dir = os.path.join(tempfile.gettempdir(), "pdf_annotation_component_v6")
    os.makedirs(component_dir, exist_ok=True)
    index_path = os.path.join(component_dir, "index.html")
...
"""
    ...
    return components.declare_component("pdf_annotation_component_v6", path=component_dir)
