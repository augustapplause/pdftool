# PDF Toolkit Version 1.7 - Browser-owned annotation editor with visual-accurate PDF export
# Annotation architecture: browser owns edit state; Streamlit updates only on explicit Save Page Annotations.
# v1.7 stores a transparent annotation overlay PNG on Save and uses it for PDF export so output matches the editor.
