...
def _ocr_cell_candidate(image, languages, numeric_only):
    """Run several single-cell OCR passes and return the strongest candidate."""
...
def recover_blank_ocr_cells(page, boundaries, table_rows, row_centres, render_zoom=5.0, languages="eng+fra"):
