...
def get_annotation_component():
    ...
    """
    component_dir = os.path.join(tempfile.gettempdir(), "pdf_fabric_annotation_component_v17")
...
"""
    ...
    return components.declare_component("pdf_fabric_annotation_component_v17", path=component_dir)
...
def show_draggable_annotation_page(page_num, base_image, annotations, settings, selected_id=None, caption=None):
    ...
    result = component(
        ...
        key=f"pdf_fabric_annotation_component_v17_page_{page_num}",
        default=None,
    )
...
with left_col:
    if task == "Convert PDF to XLSX":
        ...
        annotation_component_key = f"pdf_fabric_annotation_component_v17_page_{page_num}"
